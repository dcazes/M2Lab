...
export function FoundationSetupCard() {
  ...
  return <section className="settings-foundation-card system-foundation-card">
    ...
    <div className="settings-foundation-copy">
      ...
      <p>{foundation?.error || foundation?.events.at(-1)?.message || 'OmniLab checks Docker and Tailscale, then starts PostgreSQL, Authentik, Caddy, private routing, and Vaultwarden.'}</p>
